/*
Problem link - https://leetcode.com/problems/kids-with-the-greatest-number-of-candies/submissions/1871370148/
...
class Solution {
    public List<Boolean> kidsWithCandies(int[] candies, int extraCandies) {
        ...
        for(int item : candies)
            maxCandy = Math.max(maxCandy, item);
        
        List<Boolean> ans = new ArrayList<>();
        for(int item : candies)
            ans.add(item + extraCandies >= maxCandy);
